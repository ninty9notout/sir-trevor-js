...
/***/ (function(module, exports) {
	...
	var drop_options = {
	  html: ['<div class="st-block__dropzone">', '<svg role="img" class="st-icon"><use xlink:href="<%= config.defaults.iconUrl %>#<%= _.result(block, "icon_name") %>"/></svg>', '<p><%= st.i18n.t("general:drop", { block: "<span>" + _.result(block, "title") + "</span>" }) %>', '</p></div>'].join('\n'),
	  re_render_on_reorder: false
	};

	var paste_options = {
	  html: ['<input type="text" placeholder="<%= st.i18n.t("general:paste") %>"', ' class="st-block__paste-input st-paste-block">'].join('')
	};

	var upload_options = {
	  html: ['<div class="st-block__upload-container">', '<input type="file" type="st-file-upload">', '<button class="st-upload-btn"><%= st.i18n.t("general:upload") %></button>', '</div>'].join('\n')
	};
	...
	_Object$assign(EditorStore.prototype, {
	  ...
	  _parseData: function _parseData(data) {
	    ...
	    try {
	      ...
	      this.mediator.trigger('errors:add', { text: st.i18n.t("errors:load_fail") });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	_Object$assign(BlockPositioner.prototype, __webpack_require__(236), __webpack_require__(237), {
	  ...
	  renderPositionList: function renderPositionList() {
	    var inner = "<option value='0'>" + st.i18n.t("general:position") + "</option>";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  validateField: function validateField(field) {
	    ...
	    if (content.length === 0) {
	      this.setError(field, st.i18n.t("errors:block_empty", { name: bestNameFromField(field) }));
	    }
	  },
	  ...
	  validateBlockTypesExist: function validateBlockTypesExist(shouldValidate) {
	    ...
	    (this.required || []).forEach(function (type, index) {
	      ...
	      if (this._getBlockTypeCount(type) === 0) {
	        ...
	        this.mediator.trigger('errors:add', { text: st.i18n.t("errors:type_missing", { type: type }) });
	      } else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	_Object$assign(SimpleBlock.prototype, __webpack_require__(236), __webpack_require__(74), __webpack_require__(237), __webpack_require__(241), {
	  ...
	  title: function title() {
	    return st.i18n.t('blocks:' + this.type + ':title') || utils.titleize(this.type.replace(/[\W_]/g, ' '));
	  },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	var template = _.template(['<blockquote class="st-required st-text-block st-text-block--quote" contenteditable="true"></blockquote>', '<label class="st-input-label"> <%= st.i18n.t("blocks:quote:credit_field") %></label>', '<input maxlength="140" name="cite" placeholder="<%= st.i18n.t("blocks:quote:credit_field") %>"', ' class="st-input-string js-cite-input" type="text" />'].join("\n"));
